...
var RACKSPACE_CONFIG = {
  username: secrets.rackspace_username,
  apiKey: secrets.rackspace_apiKey,
  region: secrets.rackspace_region,
  container: secrets.rackspace_container
}
...
function doLitmus (cb) {
  gulp.src('litmus/*.html')
    .pipe(emailBuilder({
      litmus: {
        username: secrets.litmus_username,
        password: secrets.litmus_password,
        url: secrets.litmus_url,
